...
public class AuthorizationResponse extends AbstractUrlEncodedMessage implements Serializable {
   ...
   */
  public static AuthorizationResponse fromMultivaluedMap(MultivaluedMap<String, Object> multivaluedMap) throws Exception {
    return OauthUtility.fromMultivaluedMap(multivaluedMap, AuthorizationResponse.class);
  }
   ...
   */
  public static AuthorizationResponse fromUrlEncodedString(String urlEncodedString) throws Exception {
    return OauthUtility.fromUrlEncodedString(urlEncodedString, AuthorizationResponse.class);
  }
